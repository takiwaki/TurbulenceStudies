...
# input file
ifnum=580
inputHYD2D= sprintf("../HYD2D/output/spc%05d.dat",ifnum)
inputMHD2D= sprintf("../MHD2D/output/spc%05d.dat",ifnum)
...
, inputMHD2D  u 1:2 title "2D MHD" w l ls 2  \
, 6*x**(-5.0/3.0)   title "-5/3"   w l ls 3
